...
import { productDataList } from './utils/products.js';

const App = () => {

  const dispatch = useDispatch()

  const { isLoggedIn, currentToken, currentRole } = useSelector(state => state.user);
      ...
      {(!isLoggedIn && currentRole === null) &&
        <>
          ...
          <Routes>
            ...
            <Route path="/Products" element={<Products productData={productDataList} />} />
